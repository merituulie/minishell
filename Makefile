...
#    Updated: 2023/07/20 11:55:09 by rmakinen         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME):
	make -C $(LIBFT_PATH)
	cc $(BUILD_FLAGS) $(HASHMAP_SUFF) $(LEXER_SUFF) $(ENV_SUFF) $(COMMAND_SUFF) $(PARSER_SUFF) $(BUILT_SUFF) ./src/command_handler.c main.c \
