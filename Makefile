...
#    Updated: 2023/07/30 08:35:25 by emmameinert      ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME):
	make -C $(LIBFT_PATH)
	cc -L /usr/local/opt/readline/lib -I /usr/local/opt/readline/include $(BUILD_FLAGS) $(HASHMAP_SUFF) $(LEXER_SUFF) $(ENV_SUFF) $(COMMON_SUFF) \
