...
// /*   Updated: 2023/07/25 09:53:29 by jhusso           ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */
...
// 	char	**actual1 = ft_lexer(str1, env);
// 	char	**actual2 = ft_lexer(str2, env);
// 	char	**actual3 = ft_lexer(str3, env);
// 	char	**actual4 = ft_lexer(str4, env);
// 	char	**actual5 = ft_lexer(str5, env);
